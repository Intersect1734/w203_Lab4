...
Our next tested assumption is MLR.5, the assumption of homoskedacity.  From the above residuals versus fitted, we can observe that the band has a roughly uniform thickness, with the exception of points 51 and 84.  We will proceed cautiously with further analysis of homoskedasticity.
...
plot(Model1, 2)
```
Our QQ test shows that the majority of points falls on the diagonal line with some departure at the lower extreme - again in points 51 and 84.  
