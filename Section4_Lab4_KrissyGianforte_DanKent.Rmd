...
From our data outputs, we identify some heteroskedasticity, as we observed above.  In our QQ plot analysis, we note general conformity to the diagional line, with the exception of points 51, 84, and 25.  Moving further in our analysis, we again identify that points 51 and 84, while legitimate data, exert high leverage and influence.  We reckon that we are able to cautiously accept all assumptions for our classical linear multiple regression model.
